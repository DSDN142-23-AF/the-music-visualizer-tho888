...
function draw_one_frame(words, vocal, drum, bass, other, counter) {
  ...
  if (firstRun) {
    ...
    loading.push(loadImage('assets/loading/0.png'));loading.push(loadImage('assets/loading/1.png'));loading.push(loadImage('assets/loading/2.png'));loading.push(loadImage('assets/loading/3.png'));loading.push(loadImage('assets/loading/4.png'));loading.push(loadImage('assets/loading/5.png'));loading.push(loadImage('assets/loading/6.png'));loading.push(loadImage('assets/loading/7.png'));loading.push(loadImage('assets/loading/8.png'));loading.push(loadImage('assets/loading/9.png'));loading.push(loadImage('assets/loading/10.png'));loading.push(loadImage('assets/loading/11.png'));loading.push(loadImage('assets/loading/12.png'));loading.push(loadImage('assets/loading/13.png'));loading.push(loadImage('assets/loading/14.png'));
    firstRun = false;
    }
    ...
    if (counter < (128 * beat) + offset) {
      ...
      var loadingAnimation = int(map(other, 0, 100, 0, 15));
